...
- [x] [必看👍 上下文工程完全指南：6大修复技巧](./docs/02-tech-stack/14-context-engineering.md)
  ...
  - RAG：精准检索相关信息
  - Tool Loadout：动态选择工具
  - Context Quarantine：独立线程隔离
  - Context Pruning：删除无关内容
...
**遇到问题？查看完整 FAQ** 👉 [常见问题解答 (FAQ.md)](./FAQ.md)

**快速查询**：
- 💡 [零基础能学会吗？](./FAQ.md#q1-我没有-ai-基础能学会吗)
- ⏰ [需要学多久？](./FAQ.md#q2-学完大概需要多长时间)
- 🎯 [算法岗 vs 开发岗怎么选？](./FAQ.md#q3-算法岗和开发岗有什么区别我该选哪个)
- 💼 [能找到什么工作？](./FAQ.md#q7-学完能找到什么样的工作)
- 💬 [如何加入社群？](./FAQ.md#q9-如何加入学习社群)
